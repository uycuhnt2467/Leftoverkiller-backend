CREATE DATABASE  IF NOT EXISTS `leftoverkiller` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `leftoverkiller`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: localhost    Database: leftoverkiller
-- ------------------------------------------------------
...
INSERT INTO `accounts` VALUES (1,'aaa','ab89883e0473caf9531696eff7fd5e0212a0552e','a@gmail.com',NULL),(3,'aaaa','70c881d4a26984ddce795f6f71817c9cf4480e79','c@gaom.com',NULL),(4,'aaaaa','c1fe3a7b487f66a6ac8c7e4794bc55c31b0ef403','avv@gmail.com',NULL),(5,'aaaaaa','2d2929e0f1bca99d9652924ce73b7969d33ff429','AAaa@gmail.com',NULL);
...
INSERT INTO `ingredient` VALUES (1,'salt',NULL),(2,'paprika',NULL),(3,'cardamom',NULL),(4,'coriander',NULL),(5,'ground black pepper',NULL),(6,'grapeseed oil',NULL),(7,'maple syrup',NULL),(8,'salmon fillet',NULL),(9,'butter',NULL),(10,'brown sugar',NULL),(11,'soy sauce',NULL),(12,'lemon juice',NULL),(13,'white wine',NULL),(14,'garlic',NULL),(15,'olive oil',NULL),(16,'new york strip steaks',NULL),(18,'balsamic vinegar',NULL),(19,'red wine',NULL),(20,'fresh rosemary',NULL),(21,'adobo seasoning',NULL),(22,'marsala wine',NULL),(23,'ketchup',NULL),(24,'kosher salt',NULL),(25,'dried rosemary',NULL),(26,'black pepper',NULL),(27,'skirt steak',NULL),(28,'vegetable oil',NULL),(29,'red wine vinegar',NULL),(30,'worcestershire sauce',NULL),(31,'jar prepared dijon-style mustard',NULL),(32,'flank steak',NULL),(33,'carbonated beverage',NULL),(34,'coffee',NULL),(35,'rice vinegar',NULL),(36,'hot sauce',NULL),(37,'cayenne pepper',NULL),(38,'stick butter',NULL),(39,'beef top round',NULL),(40,'onions',NULL),(41,'all purpose flour',NULL),(42,'pinch paprika',NULL),(43,'beef',NULL),(44,'water',NULL),(45,'fresh parsley',NULL),(46,'stalk celery',NULL),(47,'bay leaves',NULL),(48,'dried marjoram',NULL),(49,'yukon gold potatoes',NULL),(50,'carrots',NULL),(51,'tomato paste',NULL),(52,'whole kernel corn',NULL),(53,'burgundy wine',NULL),(54,'ginger',NULL),(55,'ham steak',NULL),(56,'all-purpose flour',NULL),(57,'round steak',NULL),(58,'vegetable shortening',NULL),(59,'can whole peeled tomatoes',NULL),(60,'large green bell pepper',NULL),(61,'demi-glace ',NULL),(62,'beef tenderloin',NULL),(63,'stick unsalted butter',NULL),(64,'shallot',NULL),(65,'cognac',NULL),(66,'heavy cream',NULL),(67,'fresh chives',NULL),(68,'top sirloin',NULL),(69,'garlic powder',NULL),(70,'cube beef bouillon',NULL),(71,'cornstarch',NULL),(72,'can stewed tomatoes',NULL),(73,'white sugar',NULL),(74,'submarine/hoagie/sandwich roll',NULL),(75,'slice cheese, mozzarella, part skim milk',NULL),(76,'submarine or hoagie or sandwich roll',NULL),(77,'onion powder',NULL),(78,'cider vinegar',NULL),(79,'ground ginger',NULL),(80,'fillet salmon',NULL),(81,'peanut oil',NULL),(82,'green onions',NULL),(83,'dried red pepper flakes',NULL),(84,'sesame oil',NULL),(85,'rice wine vinegar',NULL),(86,'chili paste',NULL),(87,'fresh ginger root',NULL),(88,'leaf fresh basil',NULL),(89,'frozen green peas',NULL),(90,'juice',NULL),(91,'honey',NULL),(92,'dry bread crumbs',NULL),(93,'pecans',NULL),(94,'lemon',NULL),(95,'cedar plank',NULL),(96,'pineapple juice',NULL),(97,'drop distilled white vinegar',NULL),(98,'dried basil',NULL),(99,'tomatoes',NULL),(100,'parmesan cheese',NULL),(101,'bunch cilantro',NULL),(102,'garlic salt',NULL),(103,'leeks',NULL);
...
CREATE TABLE `recipe_ingredient` (
  ...
  KEY `fk_recipeIngredient_ingredientId` (`ingredient_id`),
...
INSERT INTO `recipe_ingredient` VALUES (167,1,1),(168,1,2),(169,1,3),(170,1,4),(171,1,5),(172,1,6),(173,1,7),(174,1,8),(175,2,8),(176,2,9),(177,2,10),(178,2,11),(179,2,12),(180,2,13),(181,5,1),(182,5,5),(183,5,14),(184,5,15),(185,5,16),(186,5,18),(187,6,1),(188,6,16),(189,6,19),(190,6,20),(191,7,1),(192,7,9),(193,7,15),(194,7,16),(197,11,14),(195,11,22),(196,11,23),(198,11,24),(199,11,25),(200,11,26),(201,11,27),(203,12,11),(205,12,12),(208,12,14),(209,12,26),(202,12,28),(204,12,29),(206,12,30),(207,12,31),(210,12,32),(217,13,1),(211,13,14),(215,13,23),(218,13,25),(216,13,26),(220,13,27),(212,13,33),(213,13,34),(214,13,35),(219,13,36),(221,13,37),(228,14,1),(229,14,26),(223,14,28),(222,14,38),(224,14,39),(225,14,40),(226,14,41),(227,14,42),(230,14,43),(231,14,44),(232,14,45),(233,14,46),(234,14,47),(235,14,48),(236,14,49),(237,14,50),(238,14,51),(239,14,52),(243,16,10),(241,16,11),(245,16,14),(242,16,15),(246,16,26),(247,16,32),(240,16,53),(244,16,54),(250,17,10),(249,17,38),(248,17,55),(259,18,1),(252,18,26),(257,18,40),(255,18,44),(251,18,56),(253,18,57),(254,18,58),(256,18,59),(258,18,60),(269,20,1),(264,20,10),(270,20,26),(261,20,28),(266,20,30),(262,20,44),(268,20,47),(260,20,68),(263,20,77),(265,20,78),(267,20,79),(281,21,1),(276,21,10),(273,21,11),(277,21,14),(274,21,18),(278,21,79),(271,21,80),(272,21,81),(275,21,82),(279,21,83),(280,21,84),(283,22,1),(286,22,10),(290,22,11),(289,22,14),(284,22,44),(282,22,80),(285,22,85),(287,22,86),(288,22,87),(291,22,88),(294,23,14),(296,23,15),(292,23,80),(293,23,89),(295,23,90),(304,24,1),(298,24,31),(297,24,38),(302,24,45),(303,24,80),(299,24,91),(300,24,92),(301,24,93),(305,24,94),(319,25,1),(316,25,2),(313,25,10),(308,25,11),(310,25,12),(311,25,15),(314,25,26),(315,25,37),(317,25,69),(318,25,80),(312,25,91),(306,25,95),(307,25,96),(309,25,97),(323,27,15),(320,27,80),(321,27,98),(322,27,99),(324,27,100),(325,28,11),(326,28,19),(328,28,26),(330,28,45),(327,28,79),(329,28,80),(331,28,94);
...
CREATE TABLE `user_ingredient` (
  ...
  PRIMARY KEY (`pair_id`),
  KEY `fk_userIngredient_userId` (`user_id`),
  KEY `fk_userIngredient_ingredientId` (`ingredient_id`),
...
INSERT INTO `user_ingredient` VALUES (1,5,2),(12,5,29),(13,5,8);
...
CREATE TABLE `user_recipe` (
  ...
  PRIMARY KEY (`pair_id`),
  KEY `fk_userRecipe_userId` (`user_id`),
  KEY `fk_userRecipe_ingredientId` (`recipe_id`),
  CONSTRAINT `fk_userRecipe_ingredientId` FOREIGN KEY (`recipe_id`) REFERENCES `recipe` (`recipe_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `user_recipe` VALUES (13,5,1),(15,5,2),(16,5,6),(18,5,12);
...
-- Dump completed on 2024-02-23 20:09:07
